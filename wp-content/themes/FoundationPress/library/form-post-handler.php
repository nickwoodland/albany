        ...
        if($data['accountId'] == 31664):
            ...
            if($submission_id && $locale_id):
                ...
                if(0 != $new_post_id):
                    ...
                    $connected_locale_q = new WP_Query($connected_locale_args);
                    ...
                    //$pdf_path_string = $pdf_folder . $submission_id .'.pdf';
                    //error_log($pdf_path_string, 0);
                    error_log(print_r($glob_pdf,true), 0);
...
add_action( 'init', 'form_post_handle' );
